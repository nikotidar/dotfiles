...
static const uint8_t offsets[] = {5,5,10,47};
// static const uint8_t offsets[] = {5,5,10,37};
///---Colors---///
...
/* static const char *termcmd[] = {"urxvt", "-geometry", "115x30", NULL }; */

static const char *termcmd[] = {"urxvt", "-geometry", "60x21", NULL };
static const char *stcmd[]   = {"xst", "-g", "73x37", NULL };
...
static key keys[] = {
    ...
    // Kill a window
    {  MOD |SHIFT,        XK_c,          killandfocus,         {.i=TWOBWM_FOCUS_PREVIOUS}},
    // Resize a window
